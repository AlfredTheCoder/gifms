<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <form class="form-horizontal" method="post" action="<?php echo base_url().'lpo/save_advance';?>" enctype="multipart/form-data">
...
<script src="<?php echo base_url().'public/js/advance_expense.js';?>"></script>