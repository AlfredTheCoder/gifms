        ...
        <div class="col-lg-12 col-md-12">
            <form class="form-horizontal" method="post" action="<?php echo base_url().'supplier/save';?>" enctype="multipart/form-data">	
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="lpostatus" name="lpostatus" required="required">
                    </div>
                </div>
				...
				<div class="form-group">
				     <label for="addresss" class="col-sm-2 control-label">Invoice Date</label>
				     <div class="col-sm-6">
				...
				<div class="form-group">
				     <label for="city" class="col-sm-2 control-label">Invoice Number</label>
				    <div class="col-sm-6">
